...
tema = None
for line in (REPO/"docs"/"pesquisa"/"hipoteses"/"perguntas.md").read_text(encoding="utf-8").splitlines():
    m = re.match(r"^## (\d+) · ", line)
...
for arq, tag in [("tasks/hipoteses.md","H"), ("docs/pesquisa/hipoteses/achados_fortes.md","A")]:
