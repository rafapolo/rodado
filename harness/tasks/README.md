...
| [`backlog.md`](backlog.md) | **O que fazer a seguir**, ordenado por retorno medido nas 274 perguntas — desambiguar dataset irmão (24 das 36 falhas), rodar os 32 casos com `n` conferido, a prosa citando tabela | 🟡 aberto 2026-09-02 — 9 itens; 0 fechado (régua), 1 e 6 codados e testados (medição ao vivo pendente), 7 parcial (só o caso sem leitura legítima virou rejeição dura); 2, 3, 4, 5, 8 nada feito |
