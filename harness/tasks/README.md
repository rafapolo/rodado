...
| [`backlog.md`](backlog.md) | **O que fazer a seguir**, ordenado por retorno medido nas 274 perguntas — desambiguar dataset irmão (24 das 36 falhas), rodar os 32 casos com `n` conferido, a prosa citando tabela | 🔴 aberto 2026-09-02 — 5 itens, nenhum feito |
...
| [`operacao.md`](operacao.md) | Checagens antes de confiar numa rodada (raciocínio desligado, cache de prefixo vivo, `-c` por slot, modelo sem saída lateral) e **6 tarefas para automatizá-las** — hoje toda checagem é inspeção manual de log | 🔴 aberto 2026-09-02 — 6 tarefas, nenhuma feita; não dependem da Fase 4 |
