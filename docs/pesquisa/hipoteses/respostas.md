...
- **T83-5 ✅ 🟠 — o canal digital registra onde há conexão.** Reclamações 2021–2023 (4,40 mi; 99,1% casadas com o diretório por nome+UF, 5.541 municípios): **716 por 100 mil hab/ano no país, mediana municipal de 197**. Taxa (log) × IBC 2022: **+0,45 bruto → +0,27 parcial** controlando PIB per capita e porte. × PIB per capita: +0,27 → **+0,14 parcial**. A conectividade explica o dobro do que a renda explica. É o padrão `registro_vs_fenomeno` de novo: o consumidor.gov.br mede quem chega ao canal. Ressalva: a tabela tem 934.672 linhas sem `Data Abertura` e 2019 com só 2 meses. Por isso a janela 2021–2023.
...
- **T89-2 ✅ ⬜ — a série existe inteira, só não pela data óbvia.** Os dois arquivos semestrais de 2019 (780.179 linhas) vieram sem `Data Abertura` e com `Data Finalização`, e por ela 2019 tem ~826 mil. O arquivo "Base Completa, Abril_2022" (154.493 linhas) foi lido numa coluna só, com os tabs dentro, e não tem UF nem data. Série: 2015 204 mil, 2016 322 mil, 2017 524 mil, 2018 681 mil, 2019 ~826 mil, **2020 1,34 mi, 2021 1,61 mi**, 2022 1,27 mi (+154 mil do arquivo quebrado), 2023 1,53 mi, 2024 1,43 mi, 2025 232 mil (2 meses). Taxa de resposta das empresas: **92,1% em 2015 → 88,1% em 2024**.
