...
[`perguntas.md`](perguntas.md), e carrega **dois eixos independentes**: se a
query rodou, e o que ela encontrou.

**Eixo 1 — status.** Responde "a query rodou?", nada além disso.
**✅ respondida** (executada no beelink, com n e resultado),
**◐ parcial** (parte do cruzamento respondida),
**⏳ pendente** (exige análise dedicada ainda não executada),
**❌ sem resposta** (bloqueio de dado verificado — ver "Bloqueios mapeados").

**Eixo 2 — força do achado.** Vem logo depois do status e responde "o que ela
encontrou?". `⏳` e `❌` não recebem glifo de força: nada rodou, não há o que medir.

| Glifo | Força | Critério |
|---|---|---|
| 🟢 | forte | \|r\| ≥ 0,50, ou contraste ≥ 2× entre grupos |
| 🟡 | moderada | 0,30 ≤ \|r\| < 0,50, ou contraste de 1,3× a 2× |
| 🟠 | fraca | 0,10 ≤ \|r\| < 0,30 |
| ⚪ | nula | \|r\| < 0,10 — hipótese refutada. **É achado, não falha** |
| ⬜ | descritivo | a entrada não é correlação: contagem, ranking, distribuição, fato |

Quando a entrada traz bruto e controlado, a força segue **o número em que a
conclusão se apoia** — o parcial, quando existe, porque foi ele que sobreviveu
ao controle de porte e renda.

Dois modificadores, colados no glifo de força:
**↯ contraria a hipótese** (o sinal é o oposto do que a pergunta esperava) ·
**⚠ número frágil** (vale como padrão, não célula a célula — cobertura desigual
da fonte, amostra mínima, ressalva de unidade).
...
de 5.570 municípios) ou estaduais (27 UFs), conforme indicado — salvo nas
rodadas que declaram Spearman no próprio cabeçalho.
...
- **T02-5 ✅ 🟢 (2026-09-25)** População jovem 0-19 (Censo 2010→2022, `br_ibge_censo_2022.populacao_grupo_idade_sexo_raca`, que guarda os dois censos sob `ano`) × matrícula na educação básica sem EJA nem profissional (Sinopse INEP, `localizacao`, 2010→2022): **r = +0,84 (n=5.565 municípios)**. Só **544** municípios ganharam população jovem; **486 deles (89%) ampliaram a matrícula**. IDEB anos iniciais, rede pública, 2011→2019: dos 517 que cresceram e têm IDEB, **96% mantiveram ou subiram** — contra 94% dos que perderam jovens; Δjovens × ΔIDEB **r = −0,06** (−0,08 até 2021). Crescer em jovens puxou matrícula e não custou IDEB, mas manter IDEB não distingue quem cresceu: quase todo município subiu no período. Conferido por outra via (2022 por idade simples em `populacao_idade_sexo`, matrícula por `etapa_ensino_serie`): r = +0,85, 523 cresceram. O texto anterior desta linha respondia outra pergunta (ΔIDEB × PIB, r = −0,07).
...
- **T05-2 ◐ 🟢⚠ (2026-09-25)** Proposições de autoria individual de senador (`br_senado_dadosabertos.materias`, 2003–2022, n=44.792; UF do sufixo "(PARTIDO/UF)" de `autoria`), classificadas por palavra-chave na `ementa`, × participação setorial no VA estadual (PIB IBGE 2003–2020, n=27 UFs). **Agro alinha:** fatia de proposições agro do estado × fatia agropecuária do VA **r=+0,64** (Spearman +0,66; parcial por log PIB **+0,63**; sem RO, outlier com 11,3%, r=+0,73). Tercil mais agro propõe 4,8% de temas agro contra 1,6% do menos agro (3,1×). **Indústria não alinha:** r=+0,04, parcial +0,06. Ressalva: classificação por regex (1.231 proposições agro), não por comissão ou relatoria; a perna TSE é a própria UF de eleição do senador.
...
- **T16-2 ◐ 🟠 (2026-09-25)** Proxy: a RF não tem arrecadação por município, então entra a arrecadação tributária própria municipal (SICONFI, conta "Impostos", receita bruta realizada, 2018–2024, mesmo plano de contas; R$ 218,5 bi em 2022). Volatilidade = desvio-padrão do crescimento log anual, descontada a mediana nacional de cada ano; concentração = HHI do emprego privado por divisão CNAE (RAIS 2021). n=5.218. **Bruto r=+0,46** (Spearman +0,54; quintil mais concentrado com volatilidade 3,2× a do menos concentrado). **Parcial por log população, log PIB per capita e UF: +0,13** (+0,10 com MAD). Quase tudo é porte (HHI × log população −0,40). Parte da volatilidade é declaração irregular no SICONFI (quedas de 75% seguidas de recuperação), não ciclo econômico.
- **T16-5 ◐ ⚪ (2026-09-25)** Mesmo proxy de T16-2 (Impostos municipais SICONFI 2022 per capita ÷ média da UF) × estabelecimentos privados com ≥250 vínculos por 10 mil hab (RAIS 2021; o CNPJ não tem porte por empregados). n=5.218, 1.639 com pelo menos um grande. **Bruto r=+0,40** (Spearman +0,41): com estabelecimento grande a arrecadação relativa mediana é 1,07× a média da UF, sem é 0,66×; dentro de cada faixa de população, 1,4–1,7×. **Parcial por log população e log PIB per capita: +0,08; com UF: +0,06.** O PIB per capita absorve: empresa grande marca município rico, não arrecadação extra por si.
...
- **T25-2 ✅ 🟢 (2026-09-25, desbloqueada por `br_cgu_orcamento_publico`)** Subvenções e equalizações do crédito rural (ações 0281 Pronaf, 0294 custeio, 0611, 0300, 0298, 00PF, 00GW, 00P4, 00Q9) somam **R$ 44,8 bi em 2014–2024**, contra R$ 647 bi de Bolsa Família/Auxílio Brasil (8442+21DP) e R$ 663 bi de BPC; em 2023, R$ 6,1 bi de subsídio rural contra R$ 166,3 bi de Bolsa Família (27×). Quem captura os dois: em 2023, 309.150 dos 1.050.108 CPFs mutuários do SICOR (29,4%; 28,4% em 2019) aparecem em algum registro de Bolsa Família (`origem_nome_cpf` do `recurso_publico_mutuario`). Esses CPFs são 23,8% das operações PF, mas só **3,8% do valor** (R$ 4,7 de 123,2 bi) e **1,7% do crédito equalizado** (R$ 1,3 de 78,3 bi). O subsídio chega ao pobre em número de contratos, não em dinheiro. Ressalva: "aparece no Bolsa Família" vale para qualquer ano.
...
- **T25-5 ✅ 🟢⚠ (2026-09-25, desbloqueada por `br_cgu_orcamento_publico`, que tem valor realizado 2014–2024 e substitui o SIOP)** Arrecadação RFB (`br_rf_arrecadacao.uf`, totais mais as partes de COFINS/PIS/CSLL/previdenciária quando o total vem nulo): R$ 1.120 bi em 2014 → R$ 2.113 bi em 2023 (+R$ 993 bi). No mesmo período, emendas empenhadas (`br_cgu_emendas_parlamentares`) R$ 6,1 → 35,4 bi (+R$ 29 bi, 5,8×) e "Juros e Encargos da Dívida" realizados R$ 170 → 241 bi (+R$ 70 bi, 1,4×). **A cada R$ 100 a mais de arrecadação, R$ 7,1 foram para juros e R$ 2,9 para emendas.** Em proporção, as emendas cresceram 4× mais rápido: de 0,54% para 1,67% da arrecadação, enquanto os juros caíram de 15,2% para 11,4% (pico de 25% em 2020). Em nível, emendas × arrecadação r=+0,64 e juros × arrecadação +0,27; em variação anual, −0,28 e −0,69. Só 10 pontos anuais.
...
- **T30-1 ✅ 🟡 (2026-09-25)** Concentração do capital social por divisão CNAE (HHI entre as matrizes ativas com capital > 0, CNPJ set/2025, 23,1M empresas) × rendimento médio e vínculos ativos (RAIS 2023, 51,0M vínculos): **r = +0,29 com salário, −0,28 com emprego (n=86 divisões)**, medido **sem a maior empresa de cada divisão** — Spearman +0,39 e −0,30. Setores dominados por poucos capitais (fumo, rádio e TV, bebidas, transporte aéreo) pagam mais e empregam menos, como a pergunta supõe, mas de forma moderada. Com a maior empresa incluída o sinal some (salário +0,08, emprego −0,02): o capital social é autodeclarado e uma declaração por divisão domina o HHI (serviços pessoais, 1,4M empresas, sai com HHI 0,91). Antes daqui a linha registrava só densidade de empresas × rendimento (+0,24, n=5.570), que não era a pergunta. *(A13)*
...
- **T38-3 ◐ ⚪⚠ (2026-09-25, só nível UF)** A formação docente segue sem grão municipal. % de docentes dos anos iniciais da rede pública no grupo 1 de adequação (INEP 2020) × taxa de alfabetização da rede pública (INEP, rede 5). Nível 2024 (n=25): r=+0,22, parcial por log PIB pc +0,13. **Melhora 2023→2024 (n=24): r=+0,06**; parcial por PIB e nível de 2023 +0,19, que **cai a +0,06 sem o RS** (−18,8 p.p. no ano da enchente). A formação docente não prevê a melhora da alfabetização.
...
- **T40-5 ◐ 🟠 (2026-09-25)** A CAPAG segue sem série (um arquivo só, "Capag Municípios 2026 - 01/06/2026"). Alternativa: ΔIFGF Firjan 2016→2022 (mediana +0,17; 3.044 municípios melhoraram mais de 0,1, 314 pioraram) × SICONFI 2015–16 → 2021–22 per capita, n=4.710. **Transferências de capital recebidas** (proxy do Transferegov): r=+0,21 (quintil que mais melhorou 3,0× contra 1,4× no que piorou), **parcial +0,08** (controle IFGF 2016, log população, log PIB pc, UF). **Despesa com pessoal:** r=−0,23, **parcial −0,16**. Despesa corrente total −0,11, parcial −0,06. Quem melhorou a gestão fiscal o fez contendo a folha mais do que recebendo investimento federal, e o efeito é fraco.
...
- **T73-5 ✅ 🟠↯ (2026-09-25, a chave existe por código)** `terceirizados.codigo_siafi_trabalho` = `viagens.pagamento.codigo_do_orgao_pagador` = `cartao_pagamento.codigo_orgao` (SIAFI), e `codigo_siape_trabalho` = `cadastro_servidores.id_org_exercicio`. O `valor` do pagamento de viagem é numérico com vírgula decimal (a "soma nula" antiga era de `viagem.valor_*`). Set/2023: 79.148 terceirizados; efetivos RJU tipo "Cargo"; diárias+passagens 2023; n=75 órgãos com ≥100 efetivos. **Terceirizados por efetivo × gasto de viagem por efetivo: r=+0,44** (Spearman +0,52), parcial por log de efetivos +0,34; **controlando o bloco MEC** (47 universidades e IFs), **+0,14**; fora do MEC (n=28), **−0,14**. Cartão corporativo: +0,13, parcial +0,08. A associação bruta era composição (MEC × ministérios), não comportamento de órgão.
...
- **M3 ✅ ⚪ (2026-09-25, proxy)** *Emenda → contrato → empresa → sanção.* A ponte é o SICONV: `siconv_emenda.ID_PROPOSTA` → `siconv_convenio.NR_CONVENIO` → `siconv_pagamento.IDENTIF_FORNECEDOR` (CNPJ de 14 dígitos). Convênios com emenda pagaram **R$ 45,6 bi a 90.655 CNPJs** (821.269 pagamentos). Contra CEIS+CNEP (14.948 sancionados), TCU inidôneos (84) e PGFN PJ (6,68 mi devedores, 2026-T1), fornecedores de emenda × só de convênio sem emenda (110.244): sancionados **1,14% × 0,79% (1,44× bruto)**; TCU 15 × 16; PGFN 22,3% × 25,0%. **Por quintil de valor recebido, o contraste some:** 0,29/0,31/0,44% × 0,43/0,46/0,70% nos quintis 1–3 (emenda *menos* sancionada), 1,27/2,38% × 1,08/1,82% nos quintis 4–5. Pago **durante sanção vigente**: R$ 166,7 mi (0,37%) contra 0,22% fora de emenda. O excesso bruto é porte do fornecedor, não captura da emenda. (A tentativa anterior pelo harness, 2026-09-03, morreu no timeout de 40 min sem convergir numa cadeia de 5 fontes.)
...
Cinco perguntas sobre datasets espelhados que nenhuma pergunta tocava.
Cada tabela teve a contagem conferida antes (catálogo = `count(*)`).

- **T83-1 ✅ 🟡↯ — o corte de 2019 pesou menos onde havia mais pobreza cadastrada.** Famílias beneficiárias caem de **14,34 mi (mai/2019) para 13,17 mi (dez/2019)**, −1,17 mi (−8,2%), enquanto as famílias no CadÚnico sobem de 27,91 para 28,88 mi. Conferido por duas vias: `cgu_beneficios_cidadao.bolsa_familia_pagamento` dá **14.339.057 e 13.170.603 NIS distintos** e R$ 2,677 bi / R$ 2,526 bi nos mesmos meses, idêntico a `mc_indicadores`. Por região o corte foi **S −12,8%, SE −11,4%, CO −11,1%, N −7,1%, NE −5,8%**; em número absoluto NE (−419 mil) e SE (−431 mil) empatam. No município (n=5.419, com ≥50 famílias em maio), variação × pessoas no CadÚnico por habitante: **r = +0,65 bruto, +0,33 dentro da UF**. Mediana −14,7% onde o CadÚnico cobre menos de 20% da população (363 municípios), −5,4% onde cobre mais da metade (2.740). A hipótese esperava o contrário: a fila fechou mais onde o programa já cobria pouco. Armadilhas da tabela: `familias_cadastradas_cu` só existe a partir de 2012, e **de abril de 2020 em diante `valor_pago_pbf` cai 96%** (R$ 0,10–0,11 bi/mês com 14,27 mi de famílias) porque o Auxílio Emergencial pagou no lugar. A soma de 2020 (R$ 8,1 bi em 9 meses) não mede o programa.
- **T83-2 ✅ ⬜ — cresce o obrigatório, o discricionário não executa, e 41% da receita é dívida rolada.** Pago 2015 → 2024, deflacionado pelo IPCA médio anual (×1,613): **Assistência social 2,30×** (R$ 69 → 257 bi), Gestão ambiental 2,81× (base de R$ 3 bi), Defesa 1,43×, C&T 1,32×, Encargos especiais 1,23×, **Previdência 1,15×, Saúde 1,15×**, Trabalho 0,97×, **Educação 0,89×, Transporte 0,74×, Agricultura 0,61×**. Execução em 2024 (pago ÷ dotação atualizada): Previdência 92%, Assistência 92%, Trabalho 91%, contra **Transporte 42%, Urbanismo 15%, Saneamento 8%**. Ordem de grandeza: Saúde tem R$ 224 bi de dotação atualizada em 2024, na ordem da LOA (~R$ 230 bi); o "realizado" é o pago no exercício, sem restos a pagar. Receita: operações de crédito são **R$ 1,86 tri dos R$ 4,50 tri realizados em 2024 (41%)**, 49% em 2021. Os R$ 5,4 tri do orçamento são quase metade refinanciamento, e Encargos especiais (R$ 2,5 tri pagos) é quem consome. Ressalva: as funções Legislativa e Judiciária não aparecem na tabela, que cobre o Executivo.
- **T83-3 ✅ ⚪ ⚠ — transparência e pendência fiscal não andam juntas.** EBT 2021 (664 municípios, todos com mais de ~50 mil habitantes) × itens com "!" no CAUC (foto de 02/09/2026, 28 itens): **r = −0,09 bruto, −0,06 parcial** controlando porte ou PIB per capita. Por quintil de nota, a fatia com alguma pendência cai de 56,4% para 39,4%, mas a população mediana sobe junto (86 mil → 124 mil): é porte. Média de 1,18 pendência na amostra do EBT contra 1,91 no país (5.569 municípios). O mais transparente segundo a CGU não está mais em dia com o Tesouro. Número frágil: EBT de 2021 e CAUC de 2026, cinco anos de distância.
- **T83-4 ✅ 🟢 — os três instrumentos põem o Brasil no mesmo lugar.** TIMSS 2023, 8º ano, média ponderada (`totwgt`, 5 valores plausíveis): **Brasil 378 em matemática e 420 em ciências**, iguais aos números oficiais da IEA. Fica em 42º de 44 sistemas nacionais, à frente só de Marrocos (378) e Costa do Marfim (263). **63,6% abaixo do patamar Baixo (400)**. Contra o PISA 2022 (média ponderada dos 10 valores plausíveis) nos 36 sistemas que estão nos dois: **r = +0,94**. O Brasil tem 378 no TIMSS e 379 no PISA, resíduo +16 (um pouco melhor no PISA do que o TIMSS prevê). A tabela agregada `br_inep_saeb.brasil` para em 2021 (9º ano, matemática: média 256,3, 62,5% até o nível 3), mas o microdado `aluno_ef_9ano` tem 2023 (média ponderada 258,0, DP 52,9; ver T86-2). A ordem é a mesma: ~6 em 10 alunos abaixo do patamar básico de cada instrumento, mas as escalas não se convertem. Armadilhas: o `country_m49` 31 do TIMSS é o Azerbaijão inteiro, e no PISA o mesmo código é só Baku (`QAZ`), o maior resíduo (−50). As entidades subnacionais do TIMSS vêm com `country_m49` nulo (26.658 alunos).
- **T83-5 ✅ 🟠 — o canal digital registra onde há conexão.** Reclamações 2021–2023 (4,56 mi, incluindo as 154 mil do arquivo de abril/2022 recuperado em 2026-09-25; 99,1% casadas com o diretório por nome+UF): **742 por 100 mil hab/ano no país, mediana municipal de 204**. Taxa (log) × IBC 2022: **+0,45 bruto → +0,27 parcial** controlando PIB per capita e porte. × PIB per capita: +0,27 → **+0,14 parcial**. A conectividade explica o dobro do que a renda explica. É o padrão `registro_vs_fenomeno` de novo: o consumidor.gov.br mede quem chega ao canal. Ressalva: os arquivos de 2019 vêm sem `Data Abertura` (ver T89-2). Por isso a janela 2021–2023.

Placar: **1 forte (T83-4) · 1 moderado contrário (T83-1) · 1 fraco (T83-5) · 1
nulo (T83-3) · 1 descritivo (T83-2)**. Nenhuma ponte nova: todos os joins
foram por `id_municipio`, pelo `country_m49` já ligado ao hub `pais` e, no
consumidor.gov.br, por nome+UF, que casa 99,1%.

## 84 · Orçamento, Receita e Execução Federal (Portal da Transparência)

- **T84-1 ✅ ⬜ — batem em 7 de 11 anos; 2020 é o descolamento.** Orçamento atualizado ÷ receita prevista (`cgu_orcamento_publico` × `cgu_receitas_publicas`): 2015 a 2019 e 2023–2024 ficam dentro de ±2% (2024: R$ 5,414 tri nas duas). Descolam **2020 (+15,4%: R$ 4,13 tri de despesa atualizada contra R$ 3,58 tri de receita prevista, os créditos extraordinários da pandemia)**, 2014 (+6,9%), 2021 (+3,7%) e 2022 (+2,8%). A receita tem 2013, o orçamento começa em 2014. Granularidade da receita muda em 2016 (~4,5 mil → ~170 mil linhas/ano), sem mudar o total.
- **T84-2 ✅ ⬜ — 23 de 31 órgãos executam menos de 80%.** 2024, órgãos com mais de R$ 1 bi de dotação, pago ÷ atualizado: **Presidência 8,5%** (R$ 25,5 bi de dotação, R$ 2,2 bi pagos), Esporte 10%, Portos e Aeroportos 16%, **Transportes 22%** (R$ 56,8 bi), Turismo 26%, Cultura 29%, Comunicações 36%, Cidades 57%, Integração 67%, Educação 75%, Fazenda 78%, Saúde 78%. Acima de 80%: Defesa 82%, CGU 84%, AGU 85%, BCB 89%, Previdência 90%, MDS 90%, Trabalho 91%, Relações Exteriores 94%. O "realizado" é o pago no exercício: o que ficou em restos a pagar conta como não executado, então parte da distância é calendário, não corte.
- **T84-3 ✅ ⚪ — a transparência não traz convênio.** Repasse de convênio SICONV 2020–2022 a prefeituras (`siconv_convenio` × `siconv_proposta`, natureza "Administração Pública Municipal"): R$ 23,06 bi para 5.088 municípios; mediana de R$ 29,9 por habitante nos 665 da EBT. Nota EBT 2021 × repasse per capita (log): **r = −0,04 bruto, +0,02 parcial** controlando porte e PIB per capita. Com o CAUC também é nulo (T83-3, −0,06). T68-1 já mostrou quem seleciona convênio: a emenda.
- **T84-4 ✅ ⬜ — RJ, saúde municipal 2022.** 88 dos 92 municípios declararam ao Siconfi (`municipio_despesas_funcao`, `conta_bd = 'Saúde'`, id 3.10.000): **empenhado R$ 23,05 bi, liquidado R$ 21,42 bi, pago R$ 20,66 bi**. Restos a pagar inscritos: R$ 1,55 bi não processados + R$ 0,74 bi processados = R$ 2,30 bi, na ordem de empenhado − pago (R$ 2,39 bi): as duas contas se conferem. Capital: R$ 6,82 bi empenhados. Somar os três estágios dá R$ 65 bi, a mesma despesa contada 2,8 vezes. As subfunções (`Demais Subfunções Saúde` etc.) são outras linhas de `conta_bd` e também não entram na soma da função.
- **T84-5 ✅ ⚪ — é porte, não prefeitura.** Servidores municipais na RAIS 2021 (vínculos ativos em 31/12, naturezas 1031, 1244, 1120 e 1147: 5,51 mi no país; mediana de 24,7 por mil habitantes nos municípios da EBT, n = 657). Nota × número de servidores: **+0,16 bruto, −0,04 parcial** controlando população e PIB per capita. × servidores por mil habitantes: −0,07. A nota acompanha, fraco, o tamanho da cidade (+0,23), não o da máquina.

## 85 · Bolsa Família 2004–2020 e o CadÚnico

- **T85-1 ✅ ⬜ — o Nordeste parou de crescer em 2014, o Sul em 2010, o Norte nunca.** Famílias (média mensal) e valor anual, 2004 → pico → 2019: **Nordeste** 2,52 mi → 7,08 mi (2014) → 6,98 mi, valor R$ 2,17 → 16,18 bi (52% do total de 2019); **Sudeste** 1,05 → 3,62 mi (2018) → 3,56 mi, R$ 0,82 → 7,57 bi; **Norte** 0,36 → 1,77 mi, pico em 2019, R$ 0,32 → 4,44 bi; **Sul** 0,44 → 1,07 mi (2010) → 0,83 mi (−22% do pico), valor com pico em 2014 (R$ 1,67 bi em 2019); **Centro-Oeste** 0,17 → 0,76 mi (2014) → 0,64 mi. 2020 fica fora: de abril em diante o valor pago cai 96% (T83-1).
- **T85-2 ✅ ⬜ — é a mesma fonte.** Valor pago em 2019 por município, `mc_indicadores` × `cgu_beneficios_cidadao.bolsa_familia_pagamento` (ano de referência): **5.570 de 5.570 dentro de 0,1%**, maior diferença R$ 62, R$ 31,159 bi nos dois lados.
- **T85-3 ✅ 🟡 — sim, e a diferença cresce com a renda.** Cobertura em dez/2019 = famílias no PBF ÷ famílias do CadÚnico com até ½ salário mínimo (`br_mds_cadunico.indicadores_municipio`): **NE 67,9%, N 63,9%, SE 50,3%, CO 45,7%, S 42,9%** (Brasil 58,9%, 22,35 mi famílias no denominador). NE × cobertura: +0,68 bruto, **+0,49 parcial** controlando PIB per capita. Em todo quintil de PIB per capita o NE cobre mais, e a distância aumenta: quintil mais pobre 77,1% × 73,1%, quintil mais rico 72,7% × 43,6%. Um município rico do Nordeste atende a fila como um pobre; um rico do Sul, não.
- **T85-4 ✅ 🟢 — o Novo Bolsa Família cresceu onde o programa cobria menos.** Mar/2020 (último mês normal do PBF, `mc_indicadores`) 13,06 mi famílias → dez/2023 **20,75 mi NIS distintos** no Novo Bolsa Família (`cgu_beneficios_cidadao.novo_bolsa_familia`): **+58,9%**, mediana municipal +41,4%, só 3,1% dos municípios perderam. **CO +92%, SE +87%, S +83%** contra NE +41% e N +52%. Variação (log) × cobertura de 2019: **r = −0,56**, × população +0,29. A expansão fechou a fila que o corte de 2019 (T83-1) tinha aberto no Centro-Sul. O meio do caminho (Auxílio Brasil, `cgu_beneficios_cidadao.auxilio_brasil`) não foi medido.
- **T85-5 ✅ ⚪ — nenhum efeito depois de descontar o ponto de partida.** 3.324 municípios com ≥300 nascidos em cada triênio. TMI mediana (SIM `idade < 1` ÷ SINASC, residência) **13,31‰ em 2009–11 → 11,27‰ em 2017–19**. Queda × cobertura do PBF em 2010 (famílias por mil habitantes): −0,06 bruto, mas a queda é quase toda regressão à média (−0,69 com a TMI inicial, e a cobertura correlaciona +0,29 com ela). TMI 2017–19 × cobertura, controlando TMI inicial, PIB per capita e porte: **+0,08**. Mesmo resultado da H08. Ressalva: 5–7 mil óbitos por ano vêm sem `idade` e ficam de fora; a TMI nacional daqui (13,0‰ em 2010, 11,4‰ em 2019) sai um pouco abaixo da oficial.

## 86 · Educação Internacional: TIMSS, PIRLS e o SAEB

- **T86-1 ✅ ⬜ — só dá para comparar com o Chile.** A América Latina do TIMSS 2023 é Brasil e Chile. Matemática, 4º ano: **Brasil 400 (56º de 59)**, Chile 443,5 (50º). 8º ano: **Brasil 378**, Chile 416 (ver T83-4).
- **T86-2 ✅ 🟢 — a mesma distância nos dois instrumentos, ~0,75 desvio-padrão.** TIMSS 8º ano, composição socioeconômica da escola segundo o diretor (`bcdgsbc`): mais afluente **418,4** (25,9% dos alunos), nem uma nem outra 379,3, mais desfavorecida **354,6** (45,6%). Diferença de 63,8 pontos = **0,75 DP** (DP brasileiro 84,6). SAEB 2023, 9º ano, matemática (microdado `aluno_ef_9ano`): por quartil do INSE médio da escola, 236,6 → 278,6, diferença de 42,0 = **0,79 DP** (DP 52,9); por quartil do INSE do aluno, 0,74 DP. As réguas medem coisas diferentes (o diretor classifica no TIMSS, o aluno responde no SAEB), e o tamanho do efeito sai o mesmo.
- **T86-3 ❌ — o PIRLS espelhado não tem o Brasil.** Nem o Chile, nem nenhum país latino-americano: são 51 códigos IEA. Portugal tem **519,8** e a Espanha 521,2, iguais aos oficiais. **Só com `pirls_type = 'Normal'`**: sem o filtro, a amostra-ponte em papel entra e Portugal sai 525,3. A resposta certa é "não há dado", não um número.
- **T86-4 ✅ 🟢 — a ordem quase não muda do 4º para o 8º.** Nos 38 sistemas que aplicaram os dois anos: **r = +0,965** entre as médias. O Brasil fica no fundo nos dois: 56º de 59 no 4º ano, 37º dos 38 com os dois anos (42º de 44 no 8º).
- **T86-5 ✅ 🟠 ⚠ — a vantagem dos meninos cresce com a idade, e no ENEM a seleção se mistura.** TIMSS, matemática: 4º ano meninos 406,5 × meninas 393,6 (**+12,9**); 8º ano 388,4 × 367,6 (**+20,8**, 0,25 DP). ENEM 2023: 560,8 × 516,8 (**+44,0**, ~0,34 DP). Mas 61% de quem fez o ENEM são mulheres (2,41 mi × 1,52 mi): o grupo feminino é menos selecionado, o que alarga a diferença sem que ela seja só de aprendizagem. O sexo no TIMSS é 1 = menina, 2 = menino, e a coluna se chama `sex_students` em `student_achievement_grade_4` e `student_sex` no resto.

## 87 · Tribunais Superiores: STJ e TCU

- **T87-1 ✅ ⬜ — 532.182 documentos, não 549.243.** STJ, 04/01 a 20/12/2021: **431.040 decisões monocráticas + 101.142 acórdãos** por `SeqDocumento` distinto. `count(*)` dá 17.061 a mais, e nem `DISTINCT *` resolve: 4.279 documentos aparecem com linhas diferentes entre si (536.461 linhas distintas). Contar por `SeqDocumento`. Assuntos, pela raiz da TPU/CNJ (um documento pode ter vários): Direito Penal 225.663 menções, Civil 216.019, Administrativo e outras de direito público 141.934, Tributário 101.089, Processual Civil e do Trabalho 93.333, Processual Penal 68.738, Consumidor 67.164, Previdenciário 57.853. A decodificação dos códigos (`00287`, `00899`...) vem da tabela pública da TPU; o espelho não a tem.
- **T87-2 ✅ ⬜ — o recesso aparece inteiro.** 4,26 decisões por acórdão no ano. **Janeiro: 2.216 decisões e nenhum acórdão**; julho: 7.093 e 2.643 (férias forenses). Agosto é o pico de decisões (64.280), a volta do represado. Nos meses de sessão normal, 36–48 mil decisões e 9–12 mil acórdãos.
- **T87-3 ✅ ⬜ — dois terços são em lote.** 36.499 acórdãos, sessões de 23/07/2024 a 08/07/2026, `key` única: **68,5% "acórdão de relação"**. Plenário 51,6%, Primeira Câmara 71,1%, Segunda 72,7%. O `sumario` vem vazio em 24.995, os de relação. `dataSessao` é texto `dd/mm/aaaa`: `min`/`max` direto na coluna devolve datas erradas; converter com `strptime` antes.
- **T87-4 ◐ ⬜ — o texto do TCU não cita CNPJ; a ponte é o número do acórdão.** Só 2 dos 36.499 sumários têm CNPJ. Pela deliberação (`DELIBERACAO = 'AC-002326/2024-PL'` ↔ número, ano e colegiado, ponte nova em `bridges.yaml`), **os 4 inidôneos com acórdão dentro da janela casam, 4 de 4**: Solarterra, Liugong Latin America, Certo Brasil e Lider Comércio, todos no Plenário, todos acórdão pleno. Os outros 3 de 2024 são de janeiro, antes da janela. No CEIS: 65 dos 84 CNPJs inidôneos, **64 com o próprio TCU como sancionador**. O CEIS republica a lista, então não é confirmação independente. Achar outras empresas "citadas" exigiria extrair nome do texto (690 sumários mencionam LTDA ou S.A.).
- **T87-5 ✅ ⬜ — o STJ é um tribunal de agravo.** **AREsp 280.793 (52,8%)**, REsp 98.135 (18,4%), **HC 92.776 (17,4%)**, RHC 19.707, CC 9.676, EAREsp 7.915, EREsp 5.795, RMS 5.170. A classe é o prefixo de `processo`.

## 88 · Rede Hidrográfica e Reservatórios (ANA)

- **T88-1 ✅ ⬜ — 5.370 trechos de ordem ≥ 7, em quatro regiões.** Pela região Otto de nível 1 (primeiro dígito de `COBACIA`), identificada pela maior área de drenagem de cada uma: **7 = São Francisco e bacias do Atlântico Leste, 1.973 trechos** (área máx. 635 mil km²); **8 = Paraná/Prata, 1.700** (3,63 mi km²); **4 = Amazonas, 1.217** (5,92 mi km²); **6 = Tocantins-Araguaia, 480** (937 mil km²). Strahler 9 só aparece no Amazonas e no Paraná. A região 7 tem mais trechos grandes que o Amazonas porque a malha é mais densa, não porque os rios são maiores. O nome da região é inferido pela área, e o BHO não traz nome de bacia.
- **T88-2 ❌ — as captações não dizem onde nem para quê.** `br_ana_outorgas.captacoes` (181.917 linhas, sem view no DuckDB, ler por `read_parquet`) tem 6 colunas: responsável, CPF/CNPJ, vazão média, município, UF e esfera. Sem trecho, sem coordenada e sem finalidade, não dá para achar "captação para abastecimento" nem pô-la no grafo. Os lançamentos (10.855) têm `ing_cd_ottobacia_trecho`, mas só 37% (4.003) casam com `COBACIA` do BHO espelhado, e 343 com `COTRECHO`: versões diferentes da base.
- **T88-3 ◐ ⬜ — sem subsistema na tabela; a média simples marca as crises.** 57% das linhas não têm volume útil (usina a fio d'água). Média anual dos reservatórios com dado, filtrando [−50, 105]: 2000 45,8%, **2001 47,2% (apagão)**, pico em 2011 (72,4%), **2014 e 2015 49,6%**, 2017 53,1%, **2021 49,4%**. Filtrar muda a média anual no máximo 1,2 ponto: dos 16.369 valores fora de [−50, 100], 11.367 estão entre 100 e 105 (reservatório vertendo, plausível), e o lixo de verdade são ~5 mil linhas. O número de reservatórios sobe de 46 para 71 ao longo da série, que para em 12/01/2022. Por subsistema exigiria a tabela de usinas do ONS, que o espelho não tem.
- **T88-4 ◐ 🟢 — Sobradinho acompanha o rio.** A tabela não tem chave de bacia; feito para um reservatório, ligado à mão: Sobradinho × índice de vazão média anual das 16 estações do Rio São Francisco (bacia 4) com ≥20 anos de série (`series_vazao_mensal_completa`, particionada, sem view). **r = +0,82** (2000–2021). A afluência do próprio reservatório × estações dá +0,99, o que valida o índice. 2017: volume médio de 10% com vazão a 42% da média. Generalizar pede o mapa reservatório → rio.
- **T88-5 ✅ ⬜ — os campeões são reservatórios pequenos; entre os grandes, Marimbondo.** Meses com média abaixo de 20%, desde 2000: **Tocos 152 de 217**, Espora 79, Ponte Nova 77, Edgard Souza 72, Retiro Baixo 71: reservatórios pequenos, vários operados baixos por desenho. Entre os grandes: **Marimbondo 54**, Itumbiara 50, Serra da Mesa 49, Nova Ponte 47, **Sobradinho 46 (mínimo de 1,7% em dez/2015)**, Furnas 30, Tucuruí 9. Sem o filtro, Tocos cai para 144 e Retiro Baixo chega a −83,8%.

## 89 · Registros que Enganam na Soma: Clima Organizacional, Consumidor e Nomes

- **T89-1 ✅ ⬜ — 32.393 respondentes.** A linha `classe = 'Médias'` dá 32.393, e os 188 órgãos de nível 1 (código sem ponto em `subclasse`) somam exatamente isso; a média ponderada deles é **55,8**, igual à oficial. **Cada linha vem duas vezes** (`area_empresa` = 'Empresa' e 'Área'), e cada `classe` é um corte do mesmo conjunto: somar `quantidade_resposta` na tabela dá 764.186 (23,6×). Dentro de "Órgão" os códigos são hierárquicos (`116.5.14.15`), e somar todos os níveis também repete gente. Melhores com ≥300 respostas: **IBGE 70,0**, UFRN 69,9, UFSM 69,3. Piores: **Polícia Federal 37,3**, INSS 44,2, Ministério da Saúde 44,8.
- **T89-2 ✅ ⬜ — a série existe inteira, só não pela data óbvia.** Os dois arquivos semestrais de 2019 (780.179 linhas) vieram sem `Data Abertura` e com `Data Finalização`, e por ela 2019 tem ~826 mil. O arquivo "Base Completa, Abril_2022" (154.493 reclamações finalizadas em abr/2022) tinha sido lido numa coluna só, com os tabs dentro; foi desmontado em 2026-09-25 (`scripts/sync/fix_consumidorgovbr_abril2022.sql`) e março/2022 passou de 48.635 para 161.661 abertas. Os arquivos mensais são cortados pela data de finalização, e nenhum outro tinha abril/2022: não há duplicata. Série: 2015 204 mil, 2016 322 mil, 2017 524 mil, 2018 681 mil, 2019 ~826 mil, **2020 1,34 mi, 2021 1,61 mi**, 2022 1,42 mi, 2023 1,53 mi, 2024 1,43 mi, 2025 232 mil (2 meses). Taxa de resposta das empresas: **92,1% em 2015 → 88,1% em 2024**.
- **T89-3 ✅ ⚪ ⚠ — não são os mesmos estados.** O PROCON do espelho é só 2024 e só 7 UFs. Reclamações por 100 mil habitantes, consumidor.gov.br × PROCON: CE 444 × 76,6, GO 659 × 15,8, SP 756 × 10,6, PE 402 × 4,6, SC 802 × 2,7, PB 399 × 1,2, MT 642 × 0,3. **r = −0,30, correlação de postos ~0** (n = 7). O que varia no PROCON é a cobertura da fonte (T50-5), não o consumidor.
- **T89-4 ✅ ⬜** Maria 11.734.129, José 5.754.470, Ana 3.089.834, João 2.984.088, Antônio 2.576.156, Francisco 1.769.237, Carlos 1.488.077, Paulo 1.422.346, Pedro 1.219.050, Lucas 1.125.716: **33,16 mi**, 23% do total da tabela. A tabela soma 144,97 mi contra 190,8 mi do Censo 2010 (76%) porque o IBGE suprime nome raro por município. O top 10 não é afetado; a soma total não é população.
- **T89-5 ✅ ⬜ — o Nordeste e o Norte têm nomes próprios; o DF é o Brasil.** Nomes do top 10 da UF que não estão no top 10 nacional: **AC 4** (Francisca, Raimundo, Antônia, Raimunda); **AL, CE, MA, PB, PE, PI e RJ, 3** (Cícero, Josefa, Severino, Raimundo, Francisca, Antônia; no RJ, Luiz, Jorge, Marcos); N e demais NE, 2; Sul, Sudeste e Centro-Oeste, 1 (Luiz, Marcos; Geraldo em MG); **DF, 0**. No RS, os dois "próprios" são a mesma pessoa em duas grafias (Luis, Luiz).

Placar 84–89: **30 perguntas, 3 ❌/◐ por dado (T86-3, T88-2, T87-4 parcial)**. Achados de método: a ponte TCU acórdão ↔ inidôneos (`bridges.yaml`); `pirls_type`; clima organizacional com respondentes contados em dobro também na verificação anterior; o consumidor.gov.br com 2019 e abril/2022 recuperáveis; `br_ana_outorgas` e `br_ana_telemetria.series_*` sem view.
...
Distribuição da **força do achado** entre as 370 entradas que rodaram
(`✅` + `◐`) — a pergunta que a tabela de status não responde:

| Força | Entradas | % |
|---|---|---|
| 🟢 forte | 101 | 27% |
| 🟠 fraca | 97 | 26% |
| ⚪ nula (hipótese refutada) | 72 | 19% |
| 🟡 moderada | 61 | 16% |
| ⬜ descritivo (não é correlação) | 39 | 11% |
| **total que rodou** | **370** | |

Somando 🟢 e 🟡, **44% das entradas que rodaram acharam relação de força ao menos
moderada**; ⚪ e 🟠 juntos (45%) são o volume de hipóteses que o dado não sustentou —
quase o mesmo tamanho, e é esse equilíbrio que o eixo de status escondia.
Nos modificadores: **26 entradas contrariam a hipótese da pergunta (↯)** e
**24 carregam número frágil (⚠)** — cobertura desigual da fonte, amostra mínima
ou ressalva de unidade.
...
documento (T05-2, T16-2, T16-5, T40-5, H29, M3 — **em 2026-09-25 todos
foram respondidos menos H29**, cuja lista de inidôneos continua com 84 CNPJs): a tabela acima conta os
