...
Mapa de entidades e relações das 1018 tabelas (226 datasets) do espelho. Gerado por `scripts/gera_erd.py` a partir de `schemas.json` em 2026-09-04 — não edite à mão, regenere.
