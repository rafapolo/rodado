...
| Arquivo | O que é | Gerado por |
|---|---|---|
| `all_tables.txt` | 1046 `dataset.tabela`, uma por linha — a lista chapada, incluindo as 8 tabelas nativas do `.duckdb` que não têm parquet | `build_metadata_catalog.py` |
